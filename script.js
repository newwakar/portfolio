...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Clear existing grid styling, make it a horizontal scroll container
    servicesGrid.style.display = 'flex';
    servicesGrid.style.overflowX = 'auto';
    servicesGrid.style.gap = '1.8rem';
    servicesGrid.style.paddingBottom = '1rem';
    ...
    // ---- Search Functionality (works on horizontal cards) ----
    ...
    // Observe all service cards, pricing cards, and contact form
    ...
    // ---- Additional animation: Typewriter effect on hero subtitle (optional) ----
